...
const featuresData = [
  ...
  },
  {
    ...
    title: 'Customiazable Workspaces',
    description: 'Personalize your worksapce for maximum efficiency.',
    highlights: [
      'Set due dates and reminders.',
      'Track progress and milestones.',
      'Easily sort taks by priority',
      ...
      <div className='container mx-auto'>
        <div className='flex gap-16'>
          ...
          <motion.div
            ...
            className='hidden xl:flex justify-center flex-1 w-full h-[480px] sticky top-[calc(50%-248px)]'
          >
